...
echo "  2. Inside the container, run $(print_color "32" "npm install") to install dependencies for the container"
echo "  3. Inside the container, run $(print_color "32" "npm run dev -- --host") to start the dev server"
